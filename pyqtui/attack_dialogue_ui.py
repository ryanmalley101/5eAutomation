...
class Ui_AttackDialogue(object):
    def setupUi(self, AttackDialogue):
        ...
        self.attack_bonus_spinbox.setMinimum(-99)
        ...
        self.damage_tablewidget = QtWidgets.QTableWidget(parent=self.groupBox)
        self.damage_tablewidget.setGridStyle(QtCore.Qt.PenStyle.SolidLine)
        self.damage_tablewidget.setCornerButtonEnabled(False)
        self.damage_tablewidget.setObjectName("damage_tablewidget")
        self.damage_tablewidget.setColumnCount(2)
        self.damage_tablewidget.setRowCount(5)
        item = QtWidgets.QTableWidgetItem()
        self.damage_tablewidget.setVerticalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.damage_tablewidget.setVerticalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.damage_tablewidget.setVerticalHeaderItem(2, item)
        item = QtWidgets.QTableWidgetItem()
        self.damage_tablewidget.setVerticalHeaderItem(3, item)
        item = QtWidgets.QTableWidgetItem()
        self.damage_tablewidget.setVerticalHeaderItem(4, item)
        item = QtWidgets.QTableWidgetItem()
        self.damage_tablewidget.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.damage_tablewidget.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.damage_tablewidget.setItem(0, 0, item)
        item = QtWidgets.QTableWidgetItem()
        self.damage_tablewidget.setItem(0, 1, item)
        self.damage_tablewidget.horizontalHeader().setVisible(True)
        self.damage_tablewidget.horizontalHeader().setDefaultSectionSize(250)
        self.damage_tablewidget.horizontalHeader().setHighlightSections(True)
        ...
        self.damage_tablewidget.verticalHeader().setMinimumSectionSize(15)
        self.verticalLayout_5.addWidget(self.damage_tablewidget)
        ...
        self.reach_spinbox = QtWidgets.QSpinBox(parent=self.groupBox)
        self.reach_spinbox.setMinimum(5)
        self.reach_spinbox.setMaximum(10000)
        self.reach_spinbox.setSingleStep(5)
        self.reach_spinbox.setObjectName("reach_spinbox")
        self.verticalLayout_4.addWidget(self.reach_spinbox)
        ...
        self.range_spinbox = QtWidgets.QSpinBox(parent=self.groupBox)
        self.range_spinbox.setMinimum(5)
        self.range_spinbox.setMaximum(10000)
        self.range_spinbox.setSingleStep(5)
        self.range_spinbox.setObjectName("range_spinbox")
        self.verticalLayout_3.addWidget(self.range_spinbox)
        ...
        self.short_range_spinbox = QtWidgets.QSpinBox(parent=self.groupBox)
        self.short_range_spinbox.setMinimum(5)
        self.short_range_spinbox.setMaximum(10000)
        self.short_range_spinbox.setSingleStep(5)
        self.short_range_spinbox.setObjectName("short_range_spinbox")
        self.verticalLayout_2.addWidget(self.short_range_spinbox)
        ...
        self.long_range_spinbox = QtWidgets.QSpinBox(parent=self.groupBox)
        self.long_range_spinbox.setMinimum(5)
        self.long_range_spinbox.setMaximum(10000)
        self.long_range_spinbox.setSingleStep(5)
        self.long_range_spinbox.setObjectName("long_range_spinbox")
        self.verticalLayout.addWidget(self.long_range_spinbox)
        ...
        self.apply_attack_pushbutton.setAutoDefault(False)
        ...
        self.delete_attack_pushbutton.setAutoDefault(False)
        ...
        self.cancel_attack_pushbutton.setAutoDefault(False)
    ...
    def retranslateUi(self, AttackDialogue):
        ...
        item = self.damage_tablewidget.verticalHeaderItem(0)
        item.setText(_translate("AttackDialogue", "Damage 1"))
        item = self.damage_tablewidget.verticalHeaderItem(1)
        item.setText(_translate("AttackDialogue", "Damage 2"))
        item = self.damage_tablewidget.verticalHeaderItem(2)
        item.setText(_translate("AttackDialogue", "Damage 3"))
        item = self.damage_tablewidget.verticalHeaderItem(3)
        item.setText(_translate("AttackDialogue", "Damage 4"))
        item = self.damage_tablewidget.verticalHeaderItem(4)
        item.setText(_translate("AttackDialogue", "Damage 5"))
        item = self.damage_tablewidget.horizontalHeaderItem(0)
        item.setText(_translate("AttackDialogue", "Dice String"))
        item = self.damage_tablewidget.horizontalHeaderItem(1)
        item.setText(_translate("AttackDialogue", "Damage Type"))
        __sortingEnabled = self.damage_tablewidget.isSortingEnabled()
        self.damage_tablewidget.setSortingEnabled(False)
        self.damage_tablewidget.setSortingEnabled(__sortingEnabled)
